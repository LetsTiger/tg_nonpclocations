...
Citizen.CreateThread( function()
    updatePath = "/LetsTiger/tg_nonpclocations"
    resourceName = "No NPC Locations Script ("..GetCurrentResourceName()..")"
...
function Resourcestart()
    print('^4.-------------------------------------------------------------------------------------------------------------------.')
    print('^4|^0                                            No NPC Locations Script                                                ^4|')
    print('^4|^0                                       <Made by Tiger (Lets_Tiger#4159)>                                           ^4|')
    print('^4|-------------------------------------------------------------------------------------------------------------------|')

    if rio then
        print("^4|▶ ^0[^1ERROR^0] ^1"..resourceName.." ist veraltet! Bitte updaten: https://github.com/LetsTiger/tg_nonpclocations/ ^4|")
